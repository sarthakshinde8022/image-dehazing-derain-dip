...
def inject_custom_css():
    st.markdown(
        ...
        /* Hide Streamlit's default menu/footer branding, keep header
           (it holds the sidebar toggle on mobile — don't hide it) */
        #MainMenu {{visibility: hidden;}}
        footer {{visibility: hidden;}}

        /* Signature element: a haze-to-clarity gradient divider,
           reused everywhere a section ends */
        .clarity-divider {{
            height: 3px;
            border: none;
            border-radius: 2px;
